...
//
// Memorija je predstavljena klasom Memorija. Pri instanciranju objekta ovog tipa se
//zadaje veličina memorije. Memorija se može čitati (metodom citaj()) i pisati
//(metodom pisi()). Obe operacije treba da budu thread-safe. I čitanje iz memorije
//i pisanje u memoriju traje po 300 ms.
//
// Magistrala je predstavljena klasom Magistrala. Magistrala ima 3 metode koje pozivaju
// procesori (citaj_memoriju(), pisi_u_memoriju(), dma()) i jednu koju poziva DMA
//kontroler (okidac_dma_kontrolera()). Sve operacije treba da budu thread-safe.
...
//Magistrala::okidac_dma_kontrolera() i u njoj čeka dok neki procesor ne zatraži
//DMA prenos.
//
// Procesori pri stvaranju dobiju zadat program (u obliku vektora naredbi) koji
//treba da izvrše. Naredbe su predstavljene objektima klase Naredba. Moguće naredbe su:
// - pisanja u memoriju,
